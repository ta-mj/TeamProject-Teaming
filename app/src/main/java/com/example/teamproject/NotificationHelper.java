...
public class NotificationHelper {
    ...
    public void createNotification(String workName) {
        ...
        notificationBuilder.setSmallIcon(R.mipmap.ic_teaming_new_round) // 기본 제공되는 이미지
        ...
        if (workName.equals(WORK_A_NAME)) {
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(mContext, WORK_A_NOTIFICATION_CODE, intent, PendingIntent.FLAG_IMMUTABLE);
